...
/*--------PROGRAM DESCRIPTION----------
*This program focuses on flipping the whole picture and flipping a part of it in differet ways.
...
*PSA4A.java aims to test the four methods:flipHorizontal,flipVertical,grayscale,collage
*PSA4B.java aims to test the two methods:flipVerticalRectangle,flipHorizontalRectangle
*ExtraCreditPSA4.java aims to test the method: scramble
 */
...
public class Picture extends SimplePicture 
{
  ...
  public void scramble(Picture originalPicture)
  {
    ...
    for (int index = 0;index < 9;index++)
    {
      ...
      //put the nine grids onto the canvas with a random order
